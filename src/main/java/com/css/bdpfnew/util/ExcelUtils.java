...
public class ExcelUtils {
    ...
    private static int exportExcel(ExcelData data, OutputStream out) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i <= (rows.size()/10000); i++){
                data.setRows(rows.subList(i*10000,(i*10000+10000)>rows.size()?rows.size():(i*10000+10000)));
                XSSFSheet sheet = wb.createSheet(sheetName+(i+1));
