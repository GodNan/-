package com.css.bdpfnew.monitor;

import com.css.bdpfnew.web.exception.ServerInternalErrorException;
...
public class ServiceMonitor {
     ...
     * in a type in the com.css.bdpfnew.service package or any sub-package
     * under that.
     */
    @Pointcut("execution(* com.css.bdpfnew.service..*(..))")
     ...
     */
    @AfterThrowing(pointcut = "com.css.bdpfnew.monitor.ServiceMonitor.serviceLayer()", throwing = "e")
