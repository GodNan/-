package com.css.bdpfnew.model.page;
...
public class Filter implements Serializable {
    ...
    /** 属性 */
    @ApiModelProperty(value = "属性", notes = "属性")
    private String property;

    /** 运算符 */
    @ApiModelProperty(value = "运算符", notes = "运算符")
    ...
    /** 是否忽略大小写 */
    @ApiModelProperty(value = "是否忽略大小写", notes = "是否忽略大小写")
     ...
     * @return 等于筛选
     */
    public static Filter gtDate(String property, Object value) {
        return new Filter(property, Operator.gtDate, value);
    }
    /**
     * 返回小于日期筛选
     *
     ...
     * @return 等于筛选
     */
    public static Filter ltDate(String property, Object value) {
        return new Filter(property, Operator.ltDate, value);
    }
