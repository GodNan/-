 ...
 * 分页信息
 */
@ApiModel(value = "分页", description = "条件查询加分页")
public class PageBean implements Serializable {
    ...
    /** 默认排序 */
    private static  final String DEFAULT_ORDER_PROPERTY = "modifyDate";
    ...
    /** 搜索属性 */
    @ApiModelProperty(value = "搜索属性",notes = "搜索属性")
    private String searchProperty;

    /** 搜索值 */
    @ApiModelProperty(value = "搜索值",notes = "搜索值")
    private String searchValue;

    /** 排序属性 */
    @ApiModelProperty(value = "排序属性",notes = "排序属性")
    private String orderProperty = DEFAULT_ORDER_PROPERTY;

    /** 排序方向 */
    @ApiModelProperty(value = "排序方向",notes = "排序方向")
    private Order.Direction orderDirection = DEFAULT_ORDER_DIRECTION;
